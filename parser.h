...
struct variable{
  int val;
  int *domaine;
  contrainte *Contraintes;		//contraintes concernant la variable
};

struct contrainte{
  variable *concernedVariables;		//Variables concernées par la contrainte
  int somme;				//-1 si contrainte de différence
};


variable * variables;			//tableau de l'ensemble des variables
